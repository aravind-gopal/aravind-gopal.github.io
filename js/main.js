  ...
  $('#form').submit(function (e) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        var successMessage = '<div class="art-success">' +
          '<i class="fas fa-check-circle art-green"></i>' +
          '<span class="art-message">Thank you! Your message has been sent.</span>' +
          '</div>';
        form.parent().append(successMessage);
      },
